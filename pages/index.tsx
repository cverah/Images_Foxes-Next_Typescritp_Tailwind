...
export default function Home() {
  ...
  const addImage: MouseEventHandler<HTMLButtonElement> = (event) => {
    ...
    //para estadística de uso en pausible
    //le ponemos windows para que sea parte de los objetos globales y estaría disponible de forma global
    window.plausible("add_image", {
      callback: navigateFn,
      props: { method: "HTTP" },
    });
  };

  const navigateFn = () => console.log("función navigate");
